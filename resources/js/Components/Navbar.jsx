    ...
    return (
        ...
        >
            <div className="flex flex-col items-center justify-center space-y-6 w-full max-w-md px-6">
                {[
                    { name: "Beranda", type: "section", target: "hero" },
                    { name: "Rekomendasi Paket", type: "section", target: "rekomendasi" },
                    ...
                    <button
                        ...
                        style={{ transitionDelay: `${idx * 50}ms`, transitionProperty: "transform, opacity, color" }}
                    >
                        {item.name}
                    </button>
                ))}
                <div
                    ...
                    style={{ transitionDelay: "350ms", transitionProperty: "transform, opacity" }}
                >
                    <button
                        onClick={() => handleNavClick("landing", "rekomendasi")}
