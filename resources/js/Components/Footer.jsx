...
import logoUrl from "../../assets/img/logo-trasa-moment.jpg";
        ...
        <footer className="bg-brand-deep text-slate-300 pt-16 pb-8 border-t border-slate-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-8 pb-12 border-b border-slate-800">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <p className="text-xs leading-relaxed text-slate-400 max-w-sm">
                            Platform penyedia layanan dokumentasi fotografi & videografi premium yang membantu Anda mengabadikan setiap momen emas kehidupan secara profesional dan transparan.
                        </p>
                        {/* Social Icons */}
                        <div className="flex space-x-4">
                            <a href="#" aria-label="Instagram" className="p-2 bg-slate-800 hover:bg-brand-primary text-slate-400 hover:text-white rounded-xl transition-all duration-300">
                            ...
                            <a href="#" aria-label="Facebook" className="p-2 bg-slate-800 hover:bg-brand-primary text-slate-400 hover:text-white rounded-xl transition-all duration-300">
                                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                                </svg>
                            </a>
                            <a href="#" aria-label="YouTube" className="p-2 bg-slate-800 hover:bg-brand-primary text-slate-400 hover:text-white rounded-xl transition-all duration-300">
                                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        <h4 className="text-sm font-bold text-white tracking-widest uppercase">Navigasi</h4>
                        <ul className="space-y-2.5 text-xs">
                            {["Beranda", "Rekomendasi Paket", "Katalog Layanan", "Alur Kerja", "Portfolio Karya"].map((item, idx) => {
                                const ids = ["hero", "rekomendasi", "layanan", "alur-kerja", "portfolio"];
                                return (
                                    <li key={idx}>
                                        <a
                                            href={`#${ids[idx]}`}
                    ...
                    <div className="lg:col-span-3 space-y-4">
                        <h4 className="text-sm font-bold text-white tracking-widest uppercase">Hubungi Kami</h4>
                        <ul className="space-y-3.5 text-xs text-slate-400">
                            <li className="flex items-start gap-3">
                                <MapPin className="w-4 h-4 text-brand-light flex-shrink-0 mt-0.5" />
                                <span>Jl. Moment Emas No. 45, Kebayoran Baru, Jakarta Selatan, 12130</span>
                            </li>
                    ...
                    <div className="lg:col-span-3 space-y-4">
                        <h4 className="text-sm font-bold text-white tracking-widest uppercase">Newsletter</h4>
                        <p className="text-xs text-slate-400 leading-relaxed">
                            Dapatkan promo paket foto menarik dan tips dokumentasi acara langsung ke email Anda.
                        </p>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center pt-8 text-2xs text-slate-500 font-medium">
                    <p>© {new Date().getFullYear()} Trasa Moment Booking System. Hak Cipta Dilindungi.</p>
                    <p className="mt-2 sm:mt-0">
                        Built for <span className="text-slate-400">Trasa Moment Agency</span>
                    </p>
                </div>
            </div>
        </footer>
